...
<div class="row">
    ...
    <div class="col-lg-4 mb-4" data-aos="fade-right">
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                @php $asp = $inscripcion->aspirante; @endphp
                <h5 class="fw-bold mb-1">{{ $asp?->nombre_completo ?? 'Aspirante eliminado' }}</h5>
                <p class="text-muted small mb-4">{{ $asp?->correo ?? '---' }}</p>
                
                <div class="mb-3">
                    <label class="small text-muted d-block text-uppercase fw-bold">Cédula</label>
                    <span class="fw-medium">{{ $asp?->ci ?? '---' }}</span>
                </div>
                <div class="mb-3">
                    <label class="small text-muted d-block text-uppercase fw-bold">Celular</label>
                    <span class="fw-medium">{{ $asp?->celular ?? '---' }}</span>
                </div>
                <div class="mb-0">
