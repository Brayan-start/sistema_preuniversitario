                ...
                <form action="{{ route('admin.cursos.update', $curso->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="horario" class="form-control @error('horario') is-invalid @enderror" value="{{ old('horario', $curso->horario) }}" placeholder="Ej: Lunes a Viernes de 18:00 a 21:00">
                        </div>
                    </div>
