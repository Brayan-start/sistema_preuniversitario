                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4 text-center">
                            @if($photoUrl)
                                <img src="{{ $photoUrl }}" alt="Foto de perfil" class="rounded-circle object-fit-cover mb-3" style="width: 130px; height: 130px;">
                            @else
                                <div class="bg-primary-subtle text-primary rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 130px; height: 130px; font-size: 3.25rem;">
