    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center p-4">
                @if($photoUrl)
                    <img src="{{ $photoUrl }}" alt="Foto de perfil" class="rounded-circle object-fit-cover mb-3" style="width: 120px; height: 120px;">
                @else
                    <div class="bg-primary-subtle text-primary rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 120px; height: 120px; font-size: 3rem;">
