    ...
    public function sheets(): array
    {
        return [
            ...
            new class($this->filters) implements FromCollection, WithHeadings, WithMapping, WithTitle {
                ...
                public function collection()
                {
                    return Inscripcion::has('aspirante')->with(['aspirante', 'curso', 'pago'])->latest()->get();
                }
                public function headings(): array
                {
            ...
            new class($this->filters) implements FromCollection, WithHeadings, WithMapping, WithTitle {
                ...
                public function collection()
                {
                    return Pago::whereHas('inscripcion.aspirante')->with(['inscripcion.aspirante', 'inscripcion.curso'])->latest()->get();
                }
                public function headings(): array
                {
