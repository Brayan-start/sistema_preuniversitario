...
class ReportRepository
{
    ...
    {
        $query = Inscripcion::has('aspirante')->with(['aspirante', 'curso', 'pago'])->latest();
    ...
    {
        $query = Pago::whereHas('inscripcion.aspirante')->with(['inscripcion.aspirante', 'inscripcion.curso'])->latest();
